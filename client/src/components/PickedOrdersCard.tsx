...
interface PickedOrdersCardProps {
  order: Order;
  writerName?: string;
  writerEmail?: string;
...
export function PickedOrdersCard({ 
  order, 
  writerName, 
  writerEmail, 
  onView, 
  userRole 
}: PickedOrdersCardProps) {
  const pickedAt = order.assignedAt || order.updatedAt;
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <span className="text-gray-900">
                  {pickedAt ? new Date(pickedAt).toLocaleString() : 'N/A'}
                </span>
              </div>
            </div>
